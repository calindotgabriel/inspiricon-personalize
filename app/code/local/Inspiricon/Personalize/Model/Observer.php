...
class Inspiricon_Personalize_Model_Observer
{
...
//        $event = $observer->getEvent();
        ...
        $leftX = $product->getMarkjuLeftX();
        $leftY = $product->getMarkjuLeftY();
        $rightX = $product->getMarkjuRightX();
        $rightY = $product->getMarkjuRightY();
        $image = $product->getMarkjuImage();


        $write = Mage::getSingleton('core/resource')->getConnection('core_write');
        $sql  = " INSERT IGNORE INTO personalize (`product_id`, `leftx`, `lefty`, `rightx`, `righty`, `imgurl`) VALUES ($entityId, $leftX, $leftY, $rightX, $rightY, '$image'); ";
        $write->query($sql);
